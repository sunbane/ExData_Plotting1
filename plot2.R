...
# plot2.R
#
# plot 2 for project 1 in Coursera Johns Hopkins Exploratory Data Analysis Class
#
# Source dataset
#
...
# Add plot with options to make it look correct
#
plot(plotdata$DT,plotdata$Global_active_power,xlab="",ylab="Global Active Power (kilowatts)",type="l")
